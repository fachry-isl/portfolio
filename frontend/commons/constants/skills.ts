...
export const skills_data: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: ["Jest", "Cypress", "Playwright", "Vitest", "Postman", "SonarQube"],
    icon: "TestTube2",
    color: "from-teal-500 to-cyan-400",
  },
  {
    name: "State Management",
    skills: ["Redux Toolkit", "Zustand", "Recoil", "Jotai", "React Query"],
    icon: "Layers",
    color: "from-indigo-500 to-violet-400",
  },
  {
    name: "Build Tools & Bundlers",
    skills: ["Webpack", "Vite", "Turbo", "esbuild", "SWC", "Babel", "Nx"],
    icon: "Hammer",
  ...
  },
  {
    ...
    skills: ["Solidity (Learning)", "Web3.js (Learning)"],
    icon: "Blocks",
